      ...
      modules: [
        ...
        },
        {
          ...
          operations: [
            ...
            {
              description: "Sets the default billing cycle for a tier",
              errors: [
                {
                  code: "SET_DEFAULT_CYCLE_TIER_NOT_FOUND",
                  description: "Tier with the specified ID does not exist",
                  id: "set-default-cycle-tier-not-found",
                  name: "SetDefaultCycleTierNotFoundError",
                  template: "",
                },
              ],
              examples: [],
              ...
              reducer:
                "const tier = state.tiers.find(t => t.id === action.input.tierId);\nif (!tier) {\n    throw new SetDefaultCycleTierNotFoundError('Tier with the specified ID does not exist');\n}\ntier.defaultBillingCycle = action.input.defaultBillingCycle;\nstate.lastModified = action.input.lastModified;",
              schema:
                "input SetTierDefaultBillingCycleInput {\n    tierId: OID!\n    defaultBillingCycle: BillingCycle!\n    lastModified: DateTime!\n}",
              scope: "global",
              template: "Sets the default billing cycle for a tier",
            },
            {
              description: "Sets billing cycle discount rules for a tier",
              errors: [
                {
                  code: "SET_CYCLE_DISCOUNTS_TIER_NOT_FOUND",
                  description: "Tier with the specified ID does not exist",
                  id: "set-cycle-discounts-tier-not-found",
                  name: "SetCycleDiscountsTierNotFoundError",
                  template: "",
                },
              ],
              examples: [],
              ...
              reducer:
                "const tier = state.tiers.find(t => t.id === action.input.tierId);\nif (!tier) {\n    throw new SetCycleDiscountsTierNotFoundError('Tier with the specified ID does not exist');\n}\ntier.billingCycleDiscounts = action.input.discounts;\nstate.lastModified = action.input.lastModified;",
              schema:
              ...
              scope: "global",
              template: "Sets billing cycle discount rules for a tier",
            },
            {
              description:
                "Sets the pricing mode for a tier (CALCULATED or MANUAL_OVERRIDE)",
              errors: [
                {
                  code: "SET_PRICING_MODE_TIER_NOT_FOUND",
                  description: "Tier with the specified ID does not exist",
                  id: "set-pricing-mode-tier-not-found",
                  name: "SetPricingModeTierNotFoundError",
                  template: "",
                },
              ],
              examples: [],
              ...
              reducer:
                "const tier = state.tiers.find(t => t.id === action.input.tierId);\nif (!tier) {\n    throw new SetPricingModeTierNotFoundError('Tier with the specified ID does not exist');\n}\ntier.pricingMode = action.input.pricingMode;\nstate.lastModified = action.input.lastModified;",
              schema:
                "input SetTierPricingModeInput {\n    tierId: OID!\n    pricingMode: TierPricingMode!\n    lastModified: DateTime!\n}",
              scope: "global",
              template: "Sets the pricing mode for a tier",
            },
          ],
        },
        {
        ...
        },
        {
          ...
          operations: [
            ...
            {
              description:
                "Sets standalone pricing for an option group (not tier-dependent)",
              errors: [
                {
                  code: "OPTION_GROUP_NOT_FOUND_SET_STANDALONE",
                  description:
                    "Option group with the specified ID does not exist",
                  id: "set-standalone-option-group-not-found",
                  name: "SetStandaloneOptionGroupNotFoundError",
                  template: "",
                },
              ],
              examples: [],
              ...
              reducer:
                "const optionGroup = state.optionGroups.find(og => og.id === action.input.optionGroupId);\nif (!optionGroup) {\n    throw new SetStandaloneOptionGroupNotFoundError('Option group with the specified ID does not exist');\n}\noptionGroup.pricingMode = 'STANDALONE';\noptionGroup.standalonePricing = {\n    setupCost: action.input.setupCost || null,\n    recurringPricing: action.input.recurringPricing\n};\noptionGroup.tierDependentPricing = [];\nstate.lastModified = action.input.lastModified;",
              schema:
            ...
            {
              description: "Adds tier-dependent pricing for an option group",
              errors: [
                {
                  code: "OPTION_GROUP_NOT_FOUND_ADD_TIER_PRICING",
                  description:
                    "Option group with the specified ID does not exist",
                  id: "add-tier-pricing-option-group-not-found",
                  name: "AddTierPricingOptionGroupNotFoundError",
                  template: "",
                },
                {
                  code: "DUPLICATE_OPTION_GROUP_TIER_PRICING_ID",
                  description:
                    "Tier pricing with this ID already exists for this option group",
                  id: "duplicate-option-group-tier-pricing-id",
                  name: "DuplicateOptionGroupTierPricingIdError",
                  template: "",
                },
              ],
              examples: [],
              ...
              reducer:
                "const optionGroup = state.optionGroups.find(og => og.id === action.input.optionGroupId);\nif (!optionGroup) {\n    throw new AddTierPricingOptionGroupNotFoundError('Option group with the specified ID does not exist');\n}\noptionGroup.pricingMode = 'TIER_DEPENDENT';\noptionGroup.standalonePricing = null;\nif (!optionGroup.tierDependentPricing) {\n    optionGroup.tierDependentPricing = [];\n}\nconst existing = optionGroup.tierDependentPricing.find(tp => tp.id === action.input.tierPricingId);\nif (existing) {\n    throw new DuplicateOptionGroupTierPricingIdError('Tier pricing with this ID already exists for this option group');\n}\noptionGroup.tierDependentPricing.push({\n    id: action.input.tierPricingId,\n    tierId: action.input.tierId,\n    setupCost: action.input.setupCost || null,\n    recurringPricing: action.input.recurringPricing.map(rp => ({ ...rp, discount: rp.discount || null }))\n});\nstate.lastModified = action.input.lastModified;",
              schema:
                "input AddOptionGroupTierPricingInput {\n    optionGroupId: OID!\n    tierPricingId: OID!\n    tierId: OID!\n    setupCost: SetupCostInput\n    recurringPricing: [RecurringPriceOptionInput!]!\n    lastModified: DateTime!\n}",
              scope: "global",
              template: "Adds tier-dependent pricing for an option group",
            },
            {
              description: "Updates tier-dependent pricing for an option group",
              errors: [
                {
                  code: "OPTION_GROUP_NOT_FOUND_UPDATE_TIER_PRICING",
                  description:
                    "Option group with the specified ID does not exist",
                  id: "update-tier-pricing-option-group-not-found",
                  name: "UpdateTierPricingOptionGroupNotFoundError",
                  template: "",
                },
                {
                  code: "TIER_PRICING_NOT_FOUND_UPDATE_OPTION_GROUP",
                  description:
                    "Tier pricing not found for the specified tier in this option group",
                  id: "update-tier-pricing-option-group-tier-not-found",
                  name: "UpdateTierPricingOptionGroupTierNotFoundError",
                  template: "",
                },
              ],
              examples: [],
              ...
              reducer:
                "const optionGroup = state.optionGroups.find(og => og.id === action.input.optionGroupId);\nif (!optionGroup) {\n    throw new UpdateTierPricingOptionGroupNotFoundError('Option group with the specified ID does not exist');\n}\nif (!optionGroup.tierDependentPricing) {\n    optionGroup.tierDependentPricing = [];\n}\nconst tierPricing = optionGroup.tierDependentPricing.find(tp => tp.tierId === action.input.tierId);\nif (!tierPricing) {\n    throw new UpdateTierPricingOptionGroupTierNotFoundError('Tier pricing not found for the specified tier in this option group');\n}\nif (action.input.setupCost !== undefined) {\n    tierPricing.setupCost = action.input.setupCost || null;\n}\nif (action.input.recurringPricing) {\n    tierPricing.recurringPricing = action.input.recurringPricing.map(rp => ({ ...rp, discount: rp.discount || null }));\n}\nstate.lastModified = action.input.lastModified;",
              schema:
                "input UpdateOptionGroupTierPricingInput {\n    optionGroupId: OID!\n    tierId: OID!\n    setupCost: SetupCostInput\n    recurringPricing: [RecurringPriceOptionInput!]\n    lastModified: DateTime!\n}",
              scope: "global",
              template: "Updates tier-dependent pricing for an option group",
            },
            {
              description: "Removes tier-dependent pricing for an option group",
              errors: [
                {
                  code: "OPTION_GROUP_NOT_FOUND_REMOVE_TIER_PRICING",
                  description:
                    "Option group with the specified ID does not exist",
                  id: "remove-tier-pricing-option-group-not-found",
                  name: "RemoveTierPricingOptionGroupNotFoundError",
                  template: "",
                },
                {
                  code: "TIER_PRICING_NOT_FOUND_REMOVE_OPTION_GROUP",
                  description:
                    "Tier pricing not found for the specified tier in this option group",
                  id: "remove-tier-pricing-option-group-tier-not-found",
                  name: "RemoveTierPricingOptionGroupTierNotFoundError",
                  template: "",
                },
              ],
              examples: [],
              ...
              reducer:
                "const optionGroup = state.optionGroups.find(og => og.id === action.input.optionGroupId);\nif (!optionGroup) {\n    throw new RemoveTierPricingOptionGroupNotFoundError('Option group with the specified ID does not exist');\n}\nif (!optionGroup.tierDependentPricing) {\n    optionGroup.tierDependentPricing = [];\n}\nconst pricingIndex = optionGroup.tierDependentPricing.findIndex(tp => tp.tierId === action.input.tierId);\nif (pricingIndex === -1) {\n    throw new RemoveTierPricingOptionGroupTierNotFoundError('Tier pricing not found for the specified tier in this option group');\n}\noptionGroup.tierDependentPricing.splice(pricingIndex, 1);\nstate.lastModified = action.input.lastModified;",
              schema:
                "input RemoveOptionGroupTierPricingInput {\n    optionGroupId: OID!\n    tierId: OID!\n    lastModified: DateTime!\n}",
              scope: "global",
              template: "Removes tier-dependent pricing for an option group",
            },
            {
              description:
                "Sets the discount mode for an option group (INHERIT_TIER or INDEPENDENT)",
              errors: [
                {
                  code: "SET_DISCOUNT_MODE_GROUP_NOT_FOUND",
                  description:
                    "Option group with the specified ID does not exist",
                  id: "set-discount-mode-group-not-found",
                  name: "SetDiscountModeGroupNotFoundError",
                  template: "",
                },
              ],
              examples: [],
              ...
              reducer:
                "const optionGroup = state.optionGroups.find(og => og.id === action.input.optionGroupId);\nif (!optionGroup) {\n    throw new SetDiscountModeGroupNotFoundError('Option group with the specified ID does not exist');\n}\noptionGroup.discountMode = action.input.discountMode;\nstate.lastModified = action.input.lastModified;",
              schema:
                "input SetOptionGroupDiscountModeInput {\n    optionGroupId: OID!\n    discountMode: DiscountMode!\n    lastModified: DateTime!\n}",
              scope: "global",
              template: "Sets the discount mode for an option group",
            },
          ],
        },
        {
          ...
          operations: [
            ...
            {
              description: "Adds tier-specific pricing to a service group",
              errors: [
                {
                  code: "SERVICE_GROUP_NOT_FOUND_ADD_TIER_PRICING",
                  description:
                    "Service group with the specified ID does not exist",
                  id: "add-tier-pricing-service-group-not-found",
                  name: "AddTierPricingServiceGroupNotFoundError",
                  template: "",
                },
                {
                  code: "TIER_NOT_FOUND_ADD_PRICING",
                  description: "Tier with the specified ID does not exist",
                  id: "add-pricing-tier-not-found",
                  name: "AddPricingTierNotFoundError",
                  template: "",
                },
                {
                  code: "DUPLICATE_TIER_PRICING_ID",
                  description:
                    "Tier pricing with this ID already exists for this service group",
                  id: "duplicate-tier-pricing-id",
                  name: "DuplicateTierPricingIdError",
                  template: "",
                },
              ],
              examples: [],
              id: "add-service-group-tier-pricing",
              name: "ADD_SERVICE_GROUP_TIER_PRICING",
              reducer:
                "const serviceGroup = state.serviceGroups.find(sg => sg.id === action.input.serviceGroupId);\nif (!serviceGroup) {\n    throw new AddTierPricingServiceGroupNotFoundError('Service group with the specified ID does not exist');\n}\nconst tier = state.tiers.find(t => t.id === action.input.tierId);\nif (!tier) {\n    throw new AddPricingTierNotFoundError('Tier with the specified ID does not exist');\n}\nif (!serviceGroup.tierPricing) {\n    serviceGroup.tierPricing = [];\n}\nconst existing = serviceGroup.tierPricing.find(tp => tp.id === action.input.tierPricingId);\nif (existing) {\n    throw new DuplicateTierPricingIdError('Tier pricing with this ID already exists for this service group');\n}\nserviceGroup.tierPricing.push({\n    id: action.input.tierPricingId,\n    tierId: action.input.tierId,\n    setupCostsPerCycle: [],\n    recurringPricing: []\n});\nstate.lastModified = action.input.lastModified;",
              schema:
                "input AddServiceGroupTierPricingInput {\n    serviceGroupId: OID!\n    tierPricingId: OID!\n    tierId: OID!\n    lastModified: DateTime!\n}",
              scope: "global",
              template: "Adds tier-specific pricing to a service group",
            },
            {
              description:
                "Sets the setup cost for a service group at a specific tier",
              errors: [
                {
                  code: "SERVICE_GROUP_NOT_FOUND_SET_SETUP",
                  description:
                    "Service group with the specified ID does not exist",
                  id: "set-setup-service-group-not-found",
                  name: "SetSetupServiceGroupNotFoundError",
                  template: "",
                },
                {
                  code: "TIER_PRICING_NOT_FOUND_SET_SETUP",
                  description:
                    "Tier pricing not found for the specified tier in this service group",
                  id: "set-setup-tier-pricing-not-found",
                  name: "SetSetupTierPricingNotFoundError",
                  template: "",
                },
              ],
              examples: [],
              id: "set-service-group-setup-cost",
              name: "SET_SERVICE_GROUP_SETUP_COST",
              reducer:
                "const serviceGroup = state.serviceGroups.find(sg => sg.id === action.input.serviceGroupId);\nif (!serviceGroup) {\n    throw new SetSetupServiceGroupNotFoundError('Service group with the specified ID does not exist');\n}\nif (!serviceGroup.tierPricing) {\n    serviceGroup.tierPricing = [];\n}\nconst tierPricing = serviceGroup.tierPricing.find(tp => tp.tierId === action.input.tierId);\nif (!tierPricing) {\n    throw new SetSetupTierPricingNotFoundError('Tier pricing not found for the specified tier in this service group');\n}\ntierPricing.setupCost = {\n    amount: action.input.amount,\n    currency: action.input.currency\n};\nstate.lastModified = action.input.lastModified;",
              schema:
            ...
            {
              description:
                "Removes the setup cost from a service group at a specific tier",
              errors: [
                {
                  code: "SERVICE_GROUP_NOT_FOUND_REMOVE_SETUP",
                  description:
                    "Service group with the specified ID does not exist",
                  id: "remove-setup-service-group-not-found",
                  name: "RemoveSetupServiceGroupNotFoundError",
                  template: "",
                },
                {
                  code: "TIER_PRICING_NOT_FOUND_REMOVE_SETUP",
                  description:
                    "Tier pricing not found for the specified tier in this service group",
                  id: "remove-setup-tier-pricing-not-found",
                  name: "RemoveSetupTierPricingNotFoundError",
                  template: "",
                },
              ],
              examples: [],
              id: "remove-service-group-setup-cost",
              name: "REMOVE_SERVICE_GROUP_SETUP_COST",
              reducer:
                "const serviceGroup = state.serviceGroups.find(sg => sg.id === action.input.serviceGroupId);\nif (!serviceGroup) {\n    throw new RemoveSetupServiceGroupNotFoundError('Service group with the specified ID does not exist');\n}\nif (!serviceGroup.tierPricing) {\n    serviceGroup.tierPricing = [];\n}\nconst tierPricing = serviceGroup.tierPricing.find(tp => tp.tierId === action.input.tierId);\nif (!tierPricing) {\n    throw new RemoveSetupTierPricingNotFoundError('Tier pricing not found for the specified tier in this service group');\n}\ntierPricing.setupCost = null;\nstate.lastModified = action.input.lastModified;",
              schema:
            ...
            {
              description:
                "Adds a recurring price option for a service group at a specific tier and billing cycle",
              errors: [
                {
                  code: "SERVICE_GROUP_NOT_FOUND_ADD_RECURRING",
                  description:
                    "Service group with the specified ID does not exist",
                  id: "add-recurring-service-group-not-found",
                  name: "AddRecurringServiceGroupNotFoundError",
                  template: "",
                },
                {
                  code: "TIER_PRICING_NOT_FOUND_ADD_RECURRING",
                  description:
                    "Tier pricing not found for the specified tier in this service group",
                  id: "add-recurring-tier-pricing-not-found",
                  name: "AddRecurringTierPricingNotFoundError",
                  template: "",
                },
                {
                  code: "DUPLICATE_PRICE_OPTION_ID",
                  description: "A price option with this ID already exists",
                  id: "duplicate-price-option-id",
                  name: "DuplicatePriceOptionIdError",
                  template: "",
                },
              ],
              examples: [],
              id: "add-recurring-price-option",
              name: "ADD_RECURRING_PRICE_OPTION",
              reducer:
                "const serviceGroup = state.serviceGroups.find(sg => sg.id === action.input.serviceGroupId);\nif (!serviceGroup) {\n    throw new AddRecurringServiceGroupNotFoundError('Service group with the specified ID does not exist');\n}\nif (!serviceGroup.tierPricing) {\n    serviceGroup.tierPricing = [];\n}\nconst tierPricing = serviceGroup.tierPricing.find(tp => tp.tierId === action.input.tierId);\nif (!tierPricing) {\n    throw new AddRecurringTierPricingNotFoundError('Tier pricing not found for the specified tier in this service group');\n}\nconst existing = tierPricing.recurringPricing.find(rp => rp.id === action.input.priceOptionId);\nif (existing) {\n    throw new DuplicatePriceOptionIdError('A price option with this ID already exists');\n}\ntierPricing.recurringPricing.push({\n    id: action.input.priceOptionId,\n    billingCycle: action.input.billingCycle,\n    amount: action.input.amount,\n    currency: action.input.currency\n});\nstate.lastModified = action.input.lastModified;",
              schema:
            ...
            {
              description:
                "Updates a recurring price option for a service group",
              errors: [
                {
                  code: "SERVICE_GROUP_NOT_FOUND_UPDATE_RECURRING",
                  description:
                    "Service group with the specified ID does not exist",
                  id: "update-recurring-service-group-not-found",
                  name: "UpdateRecurringServiceGroupNotFoundError",
                  template: "",
                },
                {
                  code: "TIER_PRICING_NOT_FOUND_UPDATE_RECURRING",
                  description:
                    "Tier pricing not found for the specified tier in this service group",
                  id: "update-recurring-tier-pricing-not-found",
                  name: "UpdateRecurringTierPricingNotFoundError",
                  template: "",
                },
                {
                  code: "PRICE_OPTION_NOT_FOUND_UPDATE",
                  description:
                    "Price option with the specified ID does not exist",
                  id: "update-price-option-not-found",
                  name: "UpdatePriceOptionNotFoundError",
                  template: "",
                },
              ],
              examples: [],
              id: "update-recurring-price-option",
              name: "UPDATE_RECURRING_PRICE_OPTION",
              reducer:
                "const serviceGroup = state.serviceGroups.find(sg => sg.id === action.input.serviceGroupId);\nif (!serviceGroup) {\n    throw new UpdateRecurringServiceGroupNotFoundError('Service group with the specified ID does not exist');\n}\nif (!serviceGroup.tierPricing) {\n    serviceGroup.tierPricing = [];\n}\nconst tierPricing = serviceGroup.tierPricing.find(tp => tp.tierId === action.input.tierId);\nif (!tierPricing) {\n    throw new UpdateRecurringTierPricingNotFoundError('Tier pricing not found for the specified tier in this service group');\n}\nconst priceOption = tierPricing.recurringPricing.find(rp => rp.id === action.input.priceOptionId);\nif (!priceOption) {\n    throw new UpdatePriceOptionNotFoundError('Price option with the specified ID does not exist');\n}\nif (action.input.billingCycle) {\n    priceOption.billingCycle = action.input.billingCycle;\n}\nif (action.input.amount !== undefined && action.input.amount !== null) {\n    priceOption.amount = action.input.amount;\n}\nif (action.input.currency) {\n    priceOption.currency = action.input.currency;\n}\nif (action.input.discount !== undefined) {\n    priceOption.discount = action.input.discount || null;\n}\nstate.lastModified = action.input.lastModified;",
              schema:
                "input UpdateRecurringPriceOptionInput {\n    serviceGroupId: OID!\n    tierId: OID!\n    priceOptionId: OID!\n    billingCycle: BillingCycle\n    amount: Amount_Money\n    currency: Currency\n    discount: DiscountRuleInput\n    lastModified: DateTime!\n}",
              scope: "global",
              template: "Updates a recurring price option for a service group",
            },
            {
              description:
                "Removes a recurring price option from a service group",
              errors: [
                {
                  code: "SERVICE_GROUP_NOT_FOUND_REMOVE_RECURRING",
                  description:
                    "Service group with the specified ID does not exist",
                  id: "remove-recurring-service-group-not-found",
                  name: "RemoveRecurringServiceGroupNotFoundError",
                  template: "",
                },
                {
                  code: "TIER_PRICING_NOT_FOUND_REMOVE_RECURRING",
                  description:
                    "Tier pricing not found for the specified tier in this service group",
                  id: "remove-recurring-tier-pricing-not-found",
                  name: "RemoveRecurringTierPricingNotFoundError",
                  template: "",
                },
                {
                  code: "PRICE_OPTION_NOT_FOUND_REMOVE",
                  description:
                    "Price option with the specified ID does not exist",
                  id: "remove-price-option-not-found",
                  name: "RemovePriceOptionNotFoundError",
                  template: "",
                },
              ],
              examples: [],
              id: "remove-recurring-price-option",
              name: "REMOVE_RECURRING_PRICE_OPTION",
              reducer:
                "const serviceGroup = state.serviceGroups.find(sg => sg.id === action.input.serviceGroupId);\nif (!serviceGroup) {\n    throw new RemoveRecurringServiceGroupNotFoundError('Service group with the specified ID does not exist');\n}\nif (!serviceGroup.tierPricing) {\n    serviceGroup.tierPricing = [];\n}\nconst tierPricing = serviceGroup.tierPricing.find(tp => tp.tierId === action.input.tierId);\nif (!tierPricing) {\n    throw new RemoveRecurringTierPricingNotFoundError('Tier pricing not found for the specified tier in this service group');\n}\nconst optionIndex = tierPricing.recurringPricing.findIndex(rp => rp.id === action.input.priceOptionId);\nif (optionIndex === -1) {\n    throw new RemovePriceOptionNotFoundError('Price option with the specified ID does not exist');\n}\ntierPricing.recurringPricing.splice(optionIndex, 1);\nstate.lastModified = action.input.lastModified;",
              schema:
                "input RemoveRecurringPriceOptionInput {\n    serviceGroupId: OID!\n    tierId: OID!\n    priceOptionId: OID!\n    lastModified: DateTime!\n}",
              scope: "global",
              template: "Removes a recurring price option from a service group",
            },
            {
              description:
                "Removes all tier-specific pricing for a service group at a specific tier",
              errors: [
                {
                  code: "SERVICE_GROUP_NOT_FOUND_REMOVE_TIER_PRICING",
                  description:
                    "Service group with the specified ID does not exist",
                  id: "remove-tier-pricing-service-group-not-found",
                  name: "RemoveTierPricingServiceGroupNotFoundError",
                  template: "",
                },
                {
                  code: "TIER_PRICING_NOT_FOUND_REMOVE",
                  description:
                    "Tier pricing not found for the specified tier in this service group",
                  id: "remove-tier-pricing-not-found",
                  name: "RemoveTierPricingNotFoundError",
                  template: "",
                },
              ],
              examples: [],
              id: "remove-service-group-tier-pricing",
              name: "REMOVE_SERVICE_GROUP_TIER_PRICING",
              reducer:
                "const serviceGroup = state.serviceGroups.find(sg => sg.id === action.input.serviceGroupId);\nif (!serviceGroup) {\n    throw new RemoveTierPricingServiceGroupNotFoundError('Service group with the specified ID does not exist');\n}\nif (!serviceGroup.tierPricing) {\n    serviceGroup.tierPricing = [];\n}\nconst pricingIndex = serviceGroup.tierPricing.findIndex(tp => tp.tierId === action.input.tierId);\nif (pricingIndex === -1) {\n    throw new RemoveTierPricingNotFoundError('Tier pricing not found for the specified tier in this service group');\n}\nserviceGroup.tierPricing.splice(pricingIndex, 1);\nstate.lastModified = action.input.lastModified;",
              schema:
