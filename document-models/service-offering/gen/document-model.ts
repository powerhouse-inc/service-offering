      ...
      modules: [
        {
          ...
          operations: [
            ...
            {
              description:
                "Set the available billing cycles for the offering. These cycles apply globally to all service groups and option groups.",
              errors: [
                {
            ...
            {
              description:
                "Set facet bindings at the offering level (moved from per-service)",
              errors: [],
              examples: [],
              id: "op-set-facet-bindings",
              name: "SET_FACET_BINDINGS",
              reducer:
          ...
          operations: [
            {
              ...
              reducer:
                "state.finalConfiguration = {\n  selectedTierId: action.input.selectedTierId,\n  selectedBillingCycle: action.input.selectedBillingCycle,\n  tierBasePrice: action.input.tierBasePrice || null,\n  tierCurrency: action.input.tierCurrency,\n  optionGroupConfigs: action.input.optionGroupConfigs.map((og) => ({\n    id: og.id,\n    optionGroupId: og.optionGroupId,\n    effectiveBillingCycle: og.effectiveBillingCycle,\n    billingCycleOverridden: og.billingCycleOverridden,\n    discountStripped: og.discountStripped,\n    recurringAmount: og.recurringAmount || null,\n    currency: og.currency || null,\n    discount: og.discount ? {\n      discountType: og.discount.discountType,\n      discountValue: og.discount.discountValue,\n      originalAmount: og.discount.originalAmount,\n      discountedAmount: og.discount.discountedAmount,\n    } : null,\n    setupCost: og.setupCost || null,\n    setupCostCurrency: og.setupCostCurrency || null,\n    setupCostDiscount: og.setupCostDiscount ? {\n      discountType: og.setupCostDiscount.discountType,\n      discountValue: og.setupCostDiscount.discountValue,\n      originalAmount: og.setupCostDiscount.originalAmount,\n      discountedAmount: og.setupCostDiscount.discountedAmount,\n    } : null,\n  })),\n  addOnConfigs: action.input.addOnConfigs.map((ao) => ({\n    id: ao.id,\n    optionGroupId: ao.optionGroupId,\n    selectedBillingCycle: ao.selectedBillingCycle,\n    recurringAmount: ao.recurringAmount || null,\n    currency: ao.currency || null,\n    discount: ao.discount ? {\n      discountType: ao.discount.discountType,\n      discountValue: ao.discount.discountValue,\n      originalAmount: ao.discount.originalAmount,\n      discountedAmount: ao.discount.discountedAmount,\n    } : null,\n    setupCost: ao.setupCost || null,\n    setupCostCurrency: ao.setupCostCurrency || null,\n    setupCostDiscount: ao.setupCostDiscount ? {\n      discountType: ao.setupCostDiscount.discountType,\n      discountValue: ao.setupCostDiscount.discountValue,\n      originalAmount: ao.setupCostDiscount.originalAmount,\n      discountedAmount: ao.setupCostDiscount.discountedAmount,\n    } : null,\n  })),\n  lastModified: action.input.lastModified,\n};",
              schema:
