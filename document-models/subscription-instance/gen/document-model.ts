  ...
  specifications: [
    {
          ...
          operations: [
            {
              ...
              reducer:
                "const { input } = action;\nlet setupCost = null;\nif (input.setupAmount && input.setupCurrency) {\n  setupCost = { amount: input.setupAmount, currency: input.setupCurrency, billingDate: input.setupBillingDate || null, paymentDate: null };\n}\nlet recurringCost = null;\nif (input.recurringAmount && input.recurringCurrency && input.recurringBillingCycle) {\n  recurringCost = { amount: input.recurringAmount, currency: input.recurringCurrency, billingCycle: input.recurringBillingCycle, nextBillingDate: null, lastPaymentDate: null };\n}\nstate.serviceGroups.push({ id: input.groupId, name: input.name, optional: input.optional, setupCost, recurringCost, services: [] });",
              schema:
      ...
      state: {
        global: {
          examples: [],
          initialValue:
            '{"customerId":null,"customerName":null,"customerEmail":null,"customerType":null,"teamMemberCount":null,"operatorId":null,"serviceOfferingId":null,"tierName":null,"tierPricingOptionId":null,"tierPrice":null,"tierCurrency":null,"selectedBillingCycle":null,"resource":null,"status":"PENDING","createdAt":null,"activatedSince":null,"pausedSince":null,"expiringSince":null,"renewalDate":null,"cancelledSince":null,"cancellationReason":null,"autoRenew":false,"operatorNotes":null,"budget":null,"nextBillingDate":null,"projectedBillAmount":null,"projectedBillCurrency":null,"services":[],"serviceGroups":[]}',
          schema:
