...
export const documentModel: DocumentModelGlobalState = {
  ...
  description:
    "Structured demo scenario decomposition with template support, prerequisite tracking, task extraction, and cross-entity dependency management for business analysis workflows.",
  extension: "phwb",
      ...
      modules: [
        ...
        },
        {
          ...
          operations: [
            {
              description:
                "Add a demo template skeleton with step/substep structure",
              errors: [],
              examples: [],
              id: "op-add-template",
              name: "ADD_TEMPLATE",
            ...
            {
              description:
                "Set extraction mode (none, pre-selected, auto-detected)",
              errors: [],
              examples: [],
            ...
            {
              description:
                "Apply a template's step structure to the current scenario",
              errors: [
                {
                  code: "TEMPLATE_NOT_FOUND",
                  description: "The specified template ID does not exist",
                ...
                },
                {
                  ...
                  description:
                    "Steps already exist in the scenario and would be overwritten",
        ...
        {
          description:
            "Stakeholder input capture and demo step/substep structuring",
          id: "mod-scenario",
          name: "scenario",
          operations: [
            {
              ...
              errors: [
                {
                  ...
                  description:
                    "The specified substep ID does not exist in the given step",
        ...
        },
        {
          ...
          operations: [
            ...
            {
              description:
                "Batch-add extracted tasks (AI-assisted or bulk import)",
              errors: [],
              examples: [],
        ...
        },
        {
          ...
          operations: [
            {
              description:
                "Persist user's AI context instructions in document state",
              errors: [],
              examples: [],
            ...
            {
              description:
                "Update an extraction record with completion status and results",
              errors: [
                {
                  code: "EXTRACTION_RECORD_NOT_FOUND",
                  description:
                    "The specified extraction record ID does not exist",
            ...
            {
              description:
                "Clear extraction history records, optionally before a given date",
              errors: [],
              examples: [],
